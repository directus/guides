...
There are two simple requests in this example worth noting. The first is in `index.vue` [here](https://github.com/directus/examples/blob/main/nuxtjs/pages/index.vue) and the other in `_id.vue` [here](https://github.com/directus/examples/blob/main/nuxtjs/pages/articles/_id.vue). However, the Directus API is exhaustive for any database linked.
